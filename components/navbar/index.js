    ...
    return (
        ...
        <div className='fixed bottom-0 w-full bg-black'>
            ...
            <ul className='mt-3 flex justify-evenly'>
                ...
                <li onClick={importData} className='relative flex w-full cursor-pointer items-center justify-center p-4 hover:opacity-50'>
                    <div>
                        <Image height={25} width={25} src={'/plus.svg'} alt='plus icon' className='h-10 w-10' />
                    </div>
                </li>
